...
const ScrollProgressIndicator = () => {
    ...
    useEffect(() => {
        ...
        document.querySelector(".scrollProgressIndicator").addEventListener("scroll", () => {
            const value = getScrollPercent();
            setDisplayScroll(value);
            console.log(value, "value scroll");
    ...
    return (
        <div className={`${styles.container} scrollProgressIndicator`}>
