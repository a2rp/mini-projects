                    ...
                    <ControlsSection>
                        <ColorsList>
                            <ul>
                                ...
                                {colors.map((c, index) => {
                                    const isActive = color?.hex?.toUpperCase() === c.hex.toUpperCase();
                                    return (
                                        <li
                                            key={index}
                        ...
                        <DisplaySection>
                            ...
                            <div className="color_history">
                                {history.map((c, idx) => (
                                    <div
                                        key={idx}
                                        className={`color ${color?.hex?.toUpperCase() === c.hex.toUpperCase() ? "active" : ""}`}
                                        onClick={() => handleColorNameClick(c)}
                                        title={c.name}
                                ...
                                <FaRegCopy
                                    ...
                                    style={{ cursor: "pointer" }}
                                    onClick={() => {
                                        const copiedText = JSON.stringify(history, null, 2);
